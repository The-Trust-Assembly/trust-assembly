  ...
  return (
    <div><div className="ta-section-rule" /><h2 className="ta-section-head">Future Vision</h2>
      <div className="ta-card" style={{ fontSize: 14, lineHeight: 1.7, color: "var(--text)" }}>
        ...
        <P>The cost of disputing escalates with each successive round — the Marks stake doubles every time, and the stake pays the jury. Earned reputation discounts the price: citizens with proven records pay half, so you pay with earned trust or money. Citizens vindicated through the Cassandra process receive their winning stake back plus a vindication premium, and a score bonus that grows with every rejection they weathered.</P>
