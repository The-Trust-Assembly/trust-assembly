  ...
  return (
    <div style={{ marginTop: 36 }}>
      <div style={{ textAlign: "center", marginBottom: 20 }}>
        ...
        <p style={{ fontSize: 10, fontFamily: "var(--mono)", textTransform: "uppercase", letterSpacing: "0.12em", color: "var(--text-muted)" }}>Ranked by trust & recency</p>
      </div>
      <div style={{ maxHeight: 440, overflowY: "auto", border: "1px solid var(--border)", borderRadius: 0, background: "var(--card-bg)" }}>
        {subs.slice(0, 20).map((sub, i) => (
          <div key={sub.id} style={{ padding: "14px 16px", borderBottom: "1px solid #EFF6FF", display: "flex", gap: 12 }}>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <a href={sub.url} target="_blank" rel="noopener" style={{ fontSize: 10, color: "var(--gold)", wordBreak: "break-all", display: "block", marginTop: 3 }}>{sub.url}</a>
