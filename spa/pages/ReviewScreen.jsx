  ...
  return (
    <div>
      ...
      <div className="ta-review-tabs">
        {[["ingroup", "In-Group", igQ.length + dQ.length], ["crossgroup", "Cross-Group", cgQ.length], ["stories", "Stories", storyProposals.length], ["disputes", "My Disputes", myDisputes.length + myRejected.length], ["myresults", "My Results", myApproved.length], ...(hasDIPartnership ? [["di", <span style={{ display: "inline-flex", alignItems: "center", gap: 4 }}><Icon name="robot" size={18} /> AI Queue</span>, diQ.length]] : [])].map(([k, l, c]) => (
