...
export default function LoginScreen({ onLogin, onGoRegister }) {
  ...
  return (
    <div style={{ maxWidth: 420, margin: "0 auto", padding: "0 16px", "--bg": "#f5f2ec", "--card-bg": "#ffffff", "--border": "#d9d3c7", "--gold": "#b8922e", "--text": "#1a1714", "--text-sec": "#5c564d", "--text-muted": "#9a948b", "--green": "#2d7a38", "--red": "#b03a2e", color: "#1a1714" }}>
