...
export default function AssemblyGuide() {
  return (
    <div style={{ padding: 16, background: "var(--card-bg)", border: "1.5px solid var(--border)", borderRadius: 0, marginBottom: 20 }}>
      ...
      <div style={{ fontSize: 13, color: "var(--text)", lineHeight: 1.7 }}>
        ...
        <div style={{ padding: 12, background: "var(--card-bg)", border: "1px solid var(--border)", borderRadius: 0, marginBottom: 14 }}>
          <div style={{ fontFamily: "var(--mono)", fontSize: 10, textTransform: "uppercase", letterSpacing: "0.08em", color: "var(--text-sec)", marginBottom: 6, fontWeight: 600 }}>⚖️ The Core Principle</div>
        ...
        <div style={{ padding: 12, background: "#ECFDF5", border: "1px solid #ECFDF5", borderRadius: 0, marginBottom: 14 }}>
        ...
        <div style={{ padding: 12, background: "#FFFBEB", border: "1px solid #FFFBEB", borderRadius: 0, marginBottom: 14 }}>
        ...
        <div style={{ padding: 12, background: "#F0FDFA", border: "1px solid #8DBDBD", borderRadius: 0, marginBottom: 14 }}>
        ...
        <div style={{ padding: 12, background: "#F5F3FF", border: "1px solid #9B7DB8", borderRadius: 0, marginBottom: 14 }}>
        ...
        <div style={{ padding: 12, background: "#EBD5D3", border: "1px solid #D4A099", borderRadius: 0, marginBottom: 14 }}>
        ...
        <div style={{ padding: 12, background: "#FFFBEB", border: "1px solid #CA8A04", borderRadius: 0, marginBottom: 14 }}>
        ...
        <div style={{ padding: 12, background: "#ECFDF5", border: "1px solid #6EE7B7", borderRadius: 0, marginBottom: 14 }}>
        ...
        <div style={{ padding: 12, background: "#EFF6FF", border: "1px solid #BFDBFE", borderRadius: 0, marginBottom: 14 }}>
          <div style={{ fontSize: 11, textTransform: "uppercase", letterSpacing: "0.06em", color: "var(--gold)", marginBottom: 6, fontWeight: 600 }}>🏅 Badges &amp; Achievements</div>
        ...
        <div style={{ padding: 12, background: "#EEF2FF", border: "1px solid #7A88B8", borderRadius: 0, marginBottom: 14 }}>
        ...
        <div style={{ padding: 12, background: "#F0FDFA", border: "1px solid #8DBDBD", borderRadius: 0 }}>
