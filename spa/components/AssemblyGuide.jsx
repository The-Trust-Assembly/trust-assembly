...
const S = { padding: 12, background: "var(--card-bg)", border: "1px solid var(--border)", borderRadius: 0, marginBottom: 14 };
  ...
  return (
    <div style={{ padding: 16, background: "var(--bg)", border: "1.5px solid var(--border)", borderRadius: 0, marginBottom: 20 }}>
      ...
      <div style={{ fontSize: 13, color: "var(--text)", lineHeight: 1.7 }}>
        ...
        <div style={{ ...S, borderLeft: "3px solid var(--text-sec)" }}>
        ...
        <div style={{ ...S, borderLeft: "3px solid var(--green)" }}>
        ...
        <div style={{ ...S, borderLeft: "3px solid #7C3AED" }}>
        ...
        <div style={{ ...S, borderLeft: "3px solid var(--red)" }}>
